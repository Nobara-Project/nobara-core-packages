...
builder = Gtk.Builder()
builder.add_from_file("/usr/lib/nobara/nobara-welcome/scripts/updater/process.ui")
...
media_logo = builder.get_object("nobara-system-software-update")
...
def nobara_sync():
	...
	terminal.spawn_sync(
		...
		os.environ['HOME'],
		["/usr/lib/nobara/nobara-welcome/scripts/updater/nobara-sync.sh"],
		[],
