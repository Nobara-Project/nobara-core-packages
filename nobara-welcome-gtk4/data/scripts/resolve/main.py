...
class Application(Gtk.ApplicationWindow):
	...
	def __init__(self):
		...
		self.builder.add_from_file("/usr/lib/nobara/nobara-welcome/scripts/resolve/main.ui")
	...
	def on_btn_accept_pressed(self, widget):
		self.builder.get_object("main_window").set_visible(False)
		def install():
			os.system("python3 /usr/lib/nobara/nobara-welcome/scripts/resolve/process.py install")
